<template>
  <div style="padding: 20px">
    ...
    <el-table v-loading="queueLoading" :data="queues" :default-sort="{prop:'name', order:'ascending'}" prop="name" style="margin-top:20px;" @selection-change="handleSelectionChange">
...
import { getQueues, addQueue, updateQueue, delQueue, exportQueue, importQueue } from '../../api/queue'
